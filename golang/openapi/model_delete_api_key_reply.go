...
// checks if the DeleteApiKeyReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteApiKeyReply{}
...
func NewNullableDeleteApiKeyReply(val *DeleteApiKeyReply) *NullableDeleteApiKeyReply {
	return &NullableDeleteApiKeyReply{value: val, isSet: true}
}
