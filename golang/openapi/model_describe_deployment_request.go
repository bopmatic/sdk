...
// checks if the DescribeDeploymentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeDeploymentRequest{}
...
func NewDescribeDeploymentRequest() *DescribeDeploymentRequest {
	this := DescribeDeploymentRequest{}
	return &this
}
...
type NullableDescribeDeploymentRequest struct {
	value *DescribeDeploymentRequest
	isSet bool
}
...
func NewNullableDescribeDeploymentRequest(val *DescribeDeploymentRequest) *NullableDescribeDeploymentRequest {
	return &NullableDescribeDeploymentRequest{value: val, isSet: true}
}
