...
// checks if the ListEnvironmentsReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListEnvironmentsReply{}
...
func NewNullableListEnvironmentsReply(val *ListEnvironmentsReply) *NullableListEnvironmentsReply {
	return &NullableListEnvironmentsReply{value: val, isSet: true}
}
