...
func (o *ListAPIKeysOK) Error() string {
	...
	return fmt.Sprintf("[POST /ServiceRunner/ListApiKeys][%d] listApiKeysOK %s", 200, payload)
}
...
func (o *ListAPIKeysOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListAPIKeysReply)
...
func (o *ListAPIKeysDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ServiceRunner/ListApiKeys][%d] ListApiKeys default %s", o._statusCode, payload)
}
