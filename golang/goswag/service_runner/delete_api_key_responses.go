...
func (o *DeleteAPIKeyOK) Error() string {
	...
	return fmt.Sprintf("[POST /ServiceRunner/DeleteApiKey][%d] deleteApiKeyOK %s", 200, payload)
}
...
func (o *DeleteAPIKeyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DeleteAPIKeyReply)
...
func (o *DeleteAPIKeyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /ServiceRunner/DeleteApiKey][%d] DeleteApiKey default %s", o._statusCode, payload)
}
