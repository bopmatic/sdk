...
func (m *DeletePackageReply) validateState(formats strfmt.Registry) error {
...
func (m *DeletePackageReply) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
