...
// GetLogsReply get logs reply
//
// swagger:model GetLogsReply
...
func (m *GetLogsReply) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetLogsReply) validateEntries(formats strfmt.Registry) error {
...
func (m *GetLogsReply) contextValidateEntries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetLogsReply) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetLogsReply) UnmarshalBinary(b []byte) error {
	var res GetLogsReply
