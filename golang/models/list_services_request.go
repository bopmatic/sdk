...
func (m *ListServicesRequest) validateHeader(formats strfmt.Registry) error {
...
// ContextValidate validate this list services request based on the context it is used
...
func (m *ListServicesRequest) contextValidateHeader(ctx context.Context, formats strfmt.Registry) error {
