...
func (m *ListDatabasesRequest) validateHeader(formats strfmt.Registry) error {
...
// ContextValidate validate this list databases request based on the context it is used
...
func (m *ListDatabasesRequest) contextValidateHeader(ctx context.Context, formats strfmt.Registry) error {
