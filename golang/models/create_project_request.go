...
func (m *CreateProjectRequest) validateHeader(formats strfmt.Registry) error {
...
func (m *CreateProjectRequest) contextValidateHeader(ctx context.Context, formats strfmt.Registry) error {
