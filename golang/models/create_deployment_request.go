...
func (m *CreateDeploymentRequest) validateHeader(formats strfmt.Registry) error {
...
func (m *CreateDeploymentRequest) contextValidateHeader(ctx context.Context, formats strfmt.Registry) error {
